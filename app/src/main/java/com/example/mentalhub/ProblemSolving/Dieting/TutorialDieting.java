...
public class TutorialDieting extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int[] images = {R.drawable.dieting_tut};
   ...
   //           getString(R.string.d_desc),
    ...
    private void openAnotherActivity() {
        Intent intent = new Intent(this, Dieting.class);
