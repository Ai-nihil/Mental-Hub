...
public class TutorialOral extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int[] images = {R.drawable.oral_tut};
   ...
   //           getString(R.string.d_desc),
    ...
    private void openAnotherActivity() {
        Intent intent = new Intent(this, Oral.class);
