...
public class TutorialRelaxation extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int[] images = {R.drawable.relax_tut};
   ...
   //           getString(R.string.d_desc),
    ...
    private void openAnotherActivity() {
        Intent intent = new Intent(this, DirtGame.class);
