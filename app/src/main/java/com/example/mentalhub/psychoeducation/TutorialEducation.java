...
public class TutorialEducation extends AppCompatActivity implements View.OnClickListener {
   ...
   //           getString(R.string.d_desc),
    ...
    private void openAnotherActivity() {
        Intent intent = new Intent(this, QuizOrLesson.class);
